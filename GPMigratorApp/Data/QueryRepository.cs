...
public class QueryRepository : IQueryRepository
{
    ...
    public QueryRepository(IAzureSqlDbConnectionFactory connection)
    {
	    _connectionFactory = connection;
    }

    public async Task<IEnumerable<BloodPressureQuery>> RunBloodPressureQuery(int age, int yearsSinceLastReading,CancellationToken cancellationToken)
    {
	    string getExisting =
